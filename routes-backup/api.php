...
// Razorpay Webhooks (no authentication required)
Route::post('/webhooks/razorpay/subscription', [RazorpayWebhookController::class, 'handleSubscriptionWebhook'])
    ->name('webhooks.razorpay.subscription');

Route::post('/webhooks/razorpay/payment', [RazorpayWebhookController::class, 'handlePaymentWebhook'])
    ->name('webhooks.razorpay.payment');
