                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#1e293b;border-radius:12px;box-shadow:0 8px 30px rgba(0,0,0,0.3);overflow:hidden;border:1px solid #334155;">
                    ...
                    <tr>
                        <td style="padding:48px 24px 32px;text-align:center;background:linear-gradient(to bottom, rgba(100,103,242,0.05), transparent);">
                            <div style="display:inline-block;width:64px;height:64px;background-color:rgba(100,103,242,0.1);border-radius:50%;padding:0;margin-bottom:24px;line-height:60px;text-align:center;">
                                <img src="{{ asset('images/email-icons/video_call.png') }}" alt="Invite" style="width:40px;height:40px;vertical-align:middle;">
                            </div>
                            <h1 style="color:#f8fafc;font-size:36px;font-weight:800;line-height:1.1;margin:0 0 12px;letter-spacing:-0.02em;">You're Invited</h1>
                            <p style="color:#cbd5e1;font-size:18px;font-weight:400;line-height:1.5;margin:0;max-width:500px;margin:0 auto;">
                                Hello {{ $userName }},<br><br>
                                {{ $organizerName }} has invited you to a session: <strong>{{ $eventTitle }}</strong>.
                            </p>
                        </td>
                    </tr>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="2" style="padding-bottom:4px;">
                                                    <span style="font-size:11px;font-weight:700;color:#6467f2;text-transform:uppercase;letter-spacing:0.15em;">Invitation</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align:middle;">
                                                                ...
                                                                @else
                                                                    <p style="color:#f8fafc;font-size:18px;font-weight:600;margin:0;">Price: {{ $currencySymbol ?? '₹' }}{{ number_format($customPrice, 2) }}</p>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <tr>
                        <td style="padding:32px 24px;border-bottom:1px solid #334155;">
                            <h3 style="color:#f8fafc;font-size:18px;font-weight:700;margin:0 0 16px;text-align:center;">Why join?</h3>
                            <p style="color:#cbd5e1;font-size:15px;line-height:1.6;margin:0;text-align:center;max-width:600px;margin:0 auto;">
                                This session is a short follow-up to address any questions or next steps. {{ $organizerName }} looks forward to connecting with you again.
                            </p>
                        </td>
                    </tr>
