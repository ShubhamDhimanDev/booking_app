...
>
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
            ...
            >
                <svg x-show="!$store.sidebar.isMobileOpen" class="fill-current" width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button
                ...
                :class="isApplicationMenuOpen ? 'bg-gray-100 dark:bg-gray-800' : ''"
            >
        ...
        >
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                >
                    <svg class="dark:hidden fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg class="hidden dark:block fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
