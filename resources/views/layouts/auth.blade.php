                ...
                <div class="mt-auto bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10 max-w-sm">
                    ...
                    <div class="flex items-center gap-3">
                        <img alt="User avatar" class="w-10 h-10 rounded-full bg-white/20"
                            src="https://ui-avatars.com/api/?name=John+Doe&color=fff&background=6366f1" />
                        <div class="text-left">
            ...
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="mb-10 flex items-center justify-between">
                    <a href="/" class="flex items-center gap-2 group cursor-pointer">
                        ...
                        <span
                            class="font-display text-2xl font-bold tracking-tight text-slate-800 dark:text-white">{{ config('app.name') }}</span>
                    </a>
                </div>
