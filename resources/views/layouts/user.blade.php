            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-6">
                    <div class="hidden md:flex gap-6">
                        <a class="text-sm font-medium {{ request()->routeIs('user.dashboard') ? 'font-semibold text-primary border-b-2 border-primary pb-1' : 'text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary' }} transition-colors"
                    ...
                    <div class="relative flex items-center gap-3 pl-6 border-l border-slate-200 dark:border-slate-700">
                        ...
                        <div id="profileDropdown" class="profile-dropdown">
                            <a href="{{ route('user.dashboard') }}" class="flex md:hidden items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-slate-700 dark:text-slate-200 {{ request()->routeIs('user.dashboard') ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}">
                                <span class="material-icons-round text-lg {{ request()->routeIs('user.dashboard') ? 'text-primary' : 'text-slate-500 dark:text-slate-400' }}">dashboard</span>
                                <span class="text-sm font-medium">Dashboard</span>
                            </a>
                            <a href="{{ route('user.bookings.index') }}" class="flex md:hidden items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-slate-700 dark:text-slate-200 {{ request()->routeIs('user.bookings.*') ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }} border-b md:border-b-0 border-slate-100 dark:border-slate-700">
                            ...
                            @if(auth()->user()->hasRole('super-admin'))
                            <a href="{{ route('super-admin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-slate-700 dark:text-slate-200 border-b border-slate-100 dark:border-slate-700">
                                <span class="material-icons-round text-lg text-purple-500">admin_panel_settings</span>
                                <span class="text-sm font-medium">Admin Panel</span>
                            </a>
                            @elseif(auth()->user()->organization)
                            <a href="{{ route('organization.dashboard') }}" class="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-slate-700 dark:text-slate-200 border-b border-slate-100 dark:border-slate-700">
                                <span class="material-icons-round text-lg text-indigo-500">business</span>
                                <span class="text-sm font-medium">Organization</span>
                            </a>
                            @endif
                            <form method="POST" action="{{ route('logout') }}" class="m-0">
                                @csrf
                                <button type="submit" class="w-full flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-slate-700 dark:text-slate-200">
